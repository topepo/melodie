test_that("prediction reserves - regression", {
	...
	res_1 <- melodie:::initialize_pred_reserve(preds_1, 2)
	...
	## iter 1
	res_1_1 <- melodie:::update_reserve(
		res_1,
		grid_size = 2,
		predictions = preds_1,
		iter = 1
	...
	## iter 2
	res_1_2 <- melodie:::update_reserve(
		res_1_1,
		grid_size = 2,
	...
	res_2 <- melodie:::initialize_pred_reserve(preds_2, 3)
	...
	## iter 1
	res_2_2 <- melodie:::update_reserve(
		res_2,
		grid_size = 2,
		predictions = preds_2,
		iter = 1
	...
	## iter 3
	res_2_3 <- melodie:::update_reserve(
		res_2_2,
		grid_size = 2,
...
test_that("prediction reserves - classification", {
	...
	res_2 <- melodie:::initialize_pred_reserve(preds_2, 1)
	...
	res_2_1 <- melodie:::update_reserve(
		NULL,
		grid_size = 2,
		predictions = preds_2,
		iter = 1
