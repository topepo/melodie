...
test_that("verifying loopy, no submodels, post estimation without tuning", {
  ...
  rs_iter <- melodie:::vec_list_rowwise(rs) |>
    purrr::pluck(1)
  ...
  data_1 <- melodie:::get_data_subsets(wflow, rs_split, rs_args)
...
test_that("verifying loopy, submodels, post estimation without tuning", {
  skip_if_not_installed("modeldata")
  skip_if_not_installed("kknn")
  skip_if_not_installed("probably")
  skip_if_not_installed("mgcv")
  ...
  data_1 <- melodie:::get_data_subsets(submodel_wflow, rs_split, rs_args)
  static_1 <- melodie:::update_static(static_1, data_1)
  static_1$y_name <- "outcome"

  submodel_res <- melodie:::loopy(rs_iter, submodel_grid, static_1)
...
test_that("verifying loopy, submodels only, post estimation without tuning", {
  ...
  data_1 <- melodie:::get_data_subsets(submodel_only_wflow, rs_split, rs_args)
  static_1 <- melodie:::update_static(static_1, data_1)
  static_1$y_name <- "class"

  submodel_only_res <- melodie:::loopy(rs_iter, submodel_only_grid, static_1)
